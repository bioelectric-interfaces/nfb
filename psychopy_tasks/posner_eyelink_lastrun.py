...
try:
    ...
    print(f'Opened EDF file at: {edf_file}')
...
for thisTrial in trials:
    ...
    el_tracker.sendMessage('TRIALID %d' % trials.thisN)
...
if p_port_3.status == STARTED:
    win.callOnFlip(p_port_3.setData, int(0))
thisExp.addData('p_port_3.started', p_port_3.tStart)
thisExp.addData('p_port_3.stopped', p_port_3.tStop)
