...
class ProtocolDialog(QtWidgets.QDialog):
    def __init__(self, parent, protocol_name='Protocol'):
        ...
        self.circle_border.addItems(['SinCircle', 'RandomCircle', 'Bar', 'Gabor', 'Plot', 'Posner', 'EyeTrack'])
        ...
        self.show_pc_score_after = QtWidgets.QCheckBox()
        self.form_layout.addRow('&Show pc score after:', self.show_pc_score_after)
    ...
    def reset_items(self):
        ...
        self.show_pc_score_after.setChecked(current_protocol['bShowPcScoreAfter'])
    ...
    def save_and_close(self):
        ...
        self.params[current_signal_index]['bShowPcScoreAfter'] = int(self.show_pc_score_after.isChecked())
